...
that information with on command.
 ...
 20:00:34 <literal> seen_bot: seen literal
 20:00:40 seen_bot literal: I last saw literal at Mon Sep 22 19:59:56 2008 on #test_channel1 saying: sdfsdfdsf
...
=head1 SYNOPSIS
 ...
 use constant {
     ...
     USER_MSG      => 1,
     DATA_FILE     => 'seen',
     SAVE_INTERVAL => 1200,   # save state every 20 mins
 };
 ...
 sub irc_botcmd_seen {
     ...
     if ($seen->{l_irc($target)}) {
         ...
         $irc->yield(privmsg => $channel, "$nick: I have not seen $target");
     }
 }
