...
=item L<Lookup|POE::Component::IRC::Cookbook::Lookup>

Have your bot look up dictionary definitions of words.

=item L<Resolver|POE::Component::IRC::Cookbook::Resolver>

Have your boot resolve DNS records for you.

=item L<Currency|POE::Component::IRC::Cookbook::Currency>

This will show you how to make your bot convert between currencies.

=item L<Seen|POE::Component::IRC::Cookbook::Seen>

Implement the "seen" feature found in many bots, which tell you when your bot
...
Have your bot remind your about something at an arbitrary date/time.
